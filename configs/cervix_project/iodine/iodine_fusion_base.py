...
train_pipeline = [
    ...
    dict(type = 'Collect', keys = ['acid_img', 'iodine_img', 'iodine_gt_bboxes', 'iodine_gt_labels']),
    # ! 将需要的东西传到检测模型中
]
test_pipeline = [
...
data = dict(
    ...
    train=dict(
        ...
        fusion=fusion,
        classes=classes,
        acid_ann_file=data_root + 'annos/train_iodine.json',
        iodine_ann_file=data_root + 'annos/train_iodine.json',
    ...
    val=dict(
        ...
        fusion=fusion,
        classes=classes,
        acid_ann_file=data_root + 'annos/val_iodine.json',
        iodine_ann_file=data_root + 'annos/val_iodine.json',
        img_prefix=data_root + 'img/',
    ...
    test=dict(
        ...
        fusion=fusion,
        classes=classes,
        acid_ann_file=data_root + 'annos/test_iodine.json',
        iodine_ann_file=data_root + 'annos/test_iodine.json',
        img_prefix=data_root + 'img/',
        pipeline=test_pipeline))
