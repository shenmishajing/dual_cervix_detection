...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        acid_ann_file=data_root + 'sil_annos/train_acid.json',
        iodine_ann_file=data_root + 'sil_annos/train_iodine.json',
        img_prefix=data_root + 'img/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        classes=classes,
        acid_ann_file=data_root + 'sil_annos/valid_acid.json',
        iodine_ann_file=data_root + 'sil_annos/valid_iodine.json',
        img_prefix=data_root + 'img/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        classes=classes,
        acid_ann_file=data_root + 'sil_annos/test_acid.json',
        iodine_ann_file=data_root + 'sil_annos/test_iodine.json',
        img_prefix=data_root + 'img/',
        pipeline=test_pipeline))
