...
data = dict(
    ...
    train=dict(#! 具体查看dataset部分的cervix.py
        ...
        iodine_ann_file=data_root + 'hsil_reannos/train_iodine.json',
        img_prefix=data_root + 'img/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        classes=classes,
        acid_ann_file=data_root + 'hsil_reannos/val_acid.json',
        iodine_ann_file=data_root + 'hsil_reannos/val_iodine.json',
        img_prefix=data_root + 'img/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        classes=classes,
        acid_ann_file=data_root + 'hsil_reannos/test_acid.json',
        iodine_ann_file=data_root + 'hsil_reannos/test_iodine.json',
        img_prefix=data_root + 'img/',
        pipeline=test_pipeline))
