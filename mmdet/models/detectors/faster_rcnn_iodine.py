...
class FasterRCNNIodine(TwoStageDetector):
    """Implementation of `Faster R-CNN <https://arxiv.org/abs/1506.01497>`_"""

    def __init__(self, backbone,
                 neck=None,
                 rpn_head_iodine=None,
                 roi_head_iodine=None,
                 prim=None,
                 train_cfg=None,
                 test_cfg=None,
                 pretrained=None,
        ...
        if rpn_head_iodine is not None:
        ...
        if roi_head_iodine is not None:
    ...
    def extract_feat(self, acid_img, iodine_img):
        ...
        return super(FasterRCNNIodine, self).extract_feat(acid_img), super(FasterRCNNIodine, self).extract_feat(iodine_img)
    ...
    def forward_train(self,
        ...
        roi_iodine_losses = self.roi_head_iodine.forward_train(acid_feats = iodine_feats, iodine_feats=acid_feats, img_metas =img_metas, acid_proposal_list =iodine_proposal_list,
                                                               acid_gt_bboxes =iodine_gt_bboxes,
                                                               acid_gt_labels =iodine_gt_labels,acid_gt_bboxes_ignore=None, **kwargs)
    ...
    def simple_test(self, acid_img, iodine_img, img_metas, acid_proposals = None, iodine_proposals = None, rescale = False):
        ...
        assert self.roi_head_iodine, 'Bbox head must be implemented.'
        acid_feats, iodine_feats = self.extract_feat(acid_img, iodine_img)
