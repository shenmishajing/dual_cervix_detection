...
class DualConsisProgFusjBBoxHead(Shared2FCBBoxHead):
    ...
    def __init__(self, loss_conscore = dict(type='SmoothL1Loss', beta=1.0 / 9.0, loss_weight=1.0),
                 ...
                 *args, **kwargs):
        super(DualConsisProgFusjBBoxHead, self).__init__(*args, **kwargs)
    ...
    def forward(self, acid_bbox_feats):
        acid_cls_score, acid_bbox_pred = super(DualConsisProgFusjBBoxHead, self).forward(acid_bbox_feats)
