...
class DualLabminRoIHead(StandardRoIHead):
    """Simplest base roi head including one bbox head and one mask head."""

    def __init__(self,
                 enlarge = False,
                 **kwargs):
        super(DualLabminRoIHead, self).__init__(**kwargs)
    ...
    def _bbox_forward(self, acid_feats, iodine_feats, acid_rois, img_metas):
        ...
        bbox_results = dict(acid_cls_score = acid_cls_score, acid_bbox_pred = acid_bbox_pred, acid_bbox_feats = acid_bbox_feats,
                            acid_proposal_offsets = acid_proposal_offsets,iodine_bbox_feats=acid_iodine_bbox_feats)
        return bbox_results
