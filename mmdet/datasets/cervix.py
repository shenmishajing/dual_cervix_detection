...
@DATASETS.register_module()
class DualLabminCervixDataset(CervixDataset):
    """
    最先好看看CocoDataset和CustomDataset，理解一下数据是怎么加载、处理的
    由acid_coco, iodine_coco构成数据集
    """
    ...
    def evaluate(self,
        ...
        iodine_results = aux_results #if self.prim == "iodine" else prim_results
        ...
        iodine_ret = super(DualLabminCervixDataset, self).evaluate_single(iodine_tf_dets, iodine_tf_annos, "_iodine")
