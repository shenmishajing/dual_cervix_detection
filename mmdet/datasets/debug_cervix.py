...
if __name__ == '__main__':
    ...
    dat = SingleCervixDataset(img_type="iodine",
                              ann_file='annos/test_iodine.json',
                              pipeline=[
                                  ...
                                  dict(
                                      ...
                                      transforms=[
                                          ...
                                          dict(type='Normalize', **dict(
                                              mean=[134.4615, 89.148, 63.189], std=[60.996, 60.333, 55.8705],
                                              to_rgb=True)),
    ...
    dat.evaluate(mmcv.load(
        '/data2/hhp/project/cervix/dual_cervix_detection/project_result/pkl/faster_rcnn_r50_fpn_2x_iodine_e10.pkl'))